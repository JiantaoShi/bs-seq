...
parser.add_argument("-count", "--count", help="Only count the number of reads.", action="store_true")
...
parser.add_argument("-debug", "--debug", help="Print bash command for debug.", action="store_true")
